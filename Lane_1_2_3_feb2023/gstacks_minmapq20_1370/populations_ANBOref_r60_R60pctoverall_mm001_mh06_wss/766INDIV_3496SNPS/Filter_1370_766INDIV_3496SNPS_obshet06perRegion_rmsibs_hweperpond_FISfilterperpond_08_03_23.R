...
#vcfR::write.vcf(VCFfiletest, file = "F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/766INDIV_3496SNPS_editlocinamesinR.vcf.gz")

# then uncompress manually in folder and upload below


#VCFfiletest<-read.vcfR("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/766INDIV_3496SNPS_editlocinamesinR.vcf")
...
#VCF.obshet06perregion<-read.vcfR("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/766INDIV_3356SNPS_editlocinamesinR_obshet06Perregion_regionID.vcf")
...
#VCFtest<-read.vcfR("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/510INDIV_1430SNPS_editlocinamesinR_rmsibsvcftools.recode.vcf")
head(VCFtest@fix[,'ID'])
...
VCF.FIS.SNPS[,c(indiv_samples_keep)]
...
VCF.FIS.SNPS.INDIV<-subset(VCF.FIS.SNPS, VCF.FIS.SNPS %in% indiv_samples_keep)

z[, c('a', 'b')]


indiv_samples_keep2 <- c(indiv_samples_keep,"x")

VCF.FIS.SNPS[,c(indiv_samples_keep2)]

filterVcf ()

library(VariantAnnotation)

ScanVcfParam(VCF.FIS.SNPS,samples=c(indiv_samples_keep))

filterVcf(VCF.FIS.SNPS, param = ScanVcfParam(samples = indiv_samples_keep))


indiv_samples_keep

indiv_samples_keep2<-col.names(INDV)


write.table(indiv_samples_keep2, "F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/Rmsibs/766INDIV_1430SNPS_indiv_samples_keep2.indv", row.names = FALSE, col.names = FALSE,quote=FALSE )
...
###  subset
VCF.HG_510_1430<-VCF.HG[VCF.HG@fix[,3]%in%SNPkeep2,]
...
#minor allele freq
VCF.HG_510_1430_mafvcf<-maf(VCF.HG_510_1430,element=2)

VCF.HG_510_1430_mafvcf.df<-as.data.frame(VCF.HG_510_1430_mafvcf)
summary(VCF.HG_510_1430_mafvcf.df)

head(VCF.HG_510_1430_mafvcf.df)
...
png("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/MAFplot_HG_510NDIV_1430SNPS_freq_2.png", width = 8, height = 6.5, units = 'in', res = 300)
hist(VCF.HG_510_1430_mafvcf.df$Frequency,breaks=seq(0,0.5,l=50), main=" ",
     ylim = c(0, 400),
     xlab="Minor allele frequency",
     ylab="Frequency")
dev.off()
...
HG_filtered.VCF2<-read.vcfR("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/766INDIV_3496SNPS_editlocinamesinR_HaidaGwai.vcf")
...
###  subset
HG_filtered.VCF_510_1430<-HG_filtered.VCF2[HG_filtered.VCF2@fix[,3]%in%SNPkeep2,]
...
#minor allele freq
HG_filtered.VCF_510_1430_mafvcf<-maf(HG_filtered.VCF_510_1430,element=2)

HG_filtered.VCF_510_1430_mafvcf.df<-as.data.frame(HG_filtered.VCF_510_1430_mafvcf)
summary(HG_filtered.VCF_510_1430_mafvcf.df)
dim(HG_filtered.VCF_510_1430_mafvcf.df) # 1430    4

head(HG_filtered.VCF_510_1430_mafvcf.df)
...
png("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/MAFplot_HG_510NDIV_1430SNPS_freq_4.png", width = 8, height = 6.5, units = 'in', res = 300)
hist(HG_filtered.VCF_510_1430_mafvcf.df$Frequency,breaks=seq(0,0.5,l=50), main=" ",
     ylim = c(0, 400),
     xlab="Minor allele frequency",
     ylab="Frequency")
dev.off()
...
HG_filtered.VCF<-read.vcfR("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/HG_510INDIV_1430SNPS_editlocinamesinR_rmsibsvcftools.recode.vcf")
...
### subset to just 1430 loci
#subset(HG_filtered.VCF, HG_filtered.VCF@fix[,3]%in%locinamnes_510_1430)

### alternative subset
#HG_filtered.VCF_510_1430<-HG_filtered.VCF[HG_filtered.VCF@fix[,3]%in%locinamnes_510_1430,]

#minor allele freq
#HG_mafvcf<-maf(HG_filtered.VCF_510_1430,element=2)

HG_mafvcf<-maf(HG_filtered.VCF,element=2)
...
png("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/MAFplot_HG_510NDIV_1430SNPS_freq.png", width = 8, height = 6.5, units = 'in', res = 300)
...
png("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/MAFplot_HG_510NDIV_1430SNPS_count.png", width = 8, height = 6.5, units = 'in', res = 300)
...
##############################
#loading the data file
VI_filtered.VCF<-read.vcfR("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/VI_510INDIV_1430SNPS_editlocinamesinR_rmsibsvcftools.recode.vcf")



### subset to just 1430 loci
#subset(VI_filtered.VCF, VI_filtered.VCF@fix[,3]%in%locinamnes_510_1430)


#VI_filtered.VCF_510_1430<-VI_filtered.VCF[VI_filtered.VCF@fix[,3]%in%locinamnes_510_1430,]

#minor allele freq
#VI_mafvcf<-maf(VI_filtered.VCF_510_1430,element=2)


VI_mafvcf<-maf(VI_filtered.VCF,element=2)
...
png("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/MAFplot_VI_510NDIV_1430SNPS_freq.png", width = 8, height = 6.5, units = 'in', res = 300)
...
png("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/MAFplot_VI_510NDIV_1430SNPS_count.png", width = 8, height = 6.5, units = 'in', res = 300)
...
##############################
#loading the data file
LM_filtered.VCF<-read.vcfR("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/LM_510INDIV_1430SNPS_editlocinamesinR_rmsibsvcftools.recode.vcf")

### subset to just 1430 loci
#subset(LM_filtered.VCF, LM_filtered.VCF@fix[,3]%in%locinamnes_510_1430)


#LM_filtered.VCF_510_1430<-LM_filtered.VCF[LM_filtered.VCF@fix[,3]%in%locinamnes_510_1430,]

#minor allele freq
#LM_mafvcf<-maf(LM_filtered.VCF_510_1430,element=2)


LM_mafvcf<-maf(LM_filtered.VCF,element=2)
...
png("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/MAFplot_LM_510NDIV_1430SNPS_freq.png", width = 8, height = 6.5, units = 'in', res = 300)
...
png("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/MAFplot_LM_510NDIV_1430SNPS_count.png", width = 8, height = 6.5, units = 'in', res = 300)
...
##############################
#loading the data file
NW_filtered.VCF<-read.vcfR("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/NW_510INDIV_1430SNPS_editlocinamesinR_rmsibsvcftools.recode.vcf")

### subset to just 1430 loci
#subset(NW_filtered.VCF, NW_filtered.VCF@fix[,3]%in%locinamnes_510_1430)


#NW_filtered.VCF_510_1430<-NW_filtered.VCF[NW_filtered.VCF@fix[,3]%in%locinamnes_510_1430,]

#minor allele freq
#NW_mafvcf<-maf(NW_filtered.VCF_510_1430,element=2)


NW_mafvcf<-maf(NW_filtered.VCF,element=2)
...
png("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/MAFplot_NW_510NDIV_1430SNPS_freq.png", width = 8, height = 6.5, units = 'in', res = 300)
...
png("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/MAFplot_NW_510NDIV_1430SNPS_count.png", width = 8, height = 6.5, units = 'in', res = 300)
...
ggsave("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/SFS_4clusters_MAF_vs_locicount_510_1430.svg", width = 3.5, height = 6.5, units = 'in')
ggplot(data=allfourregions, aes(x=Frequency,fill=Region)) +
  geom_histogram()+
  scale_fill_manual(values=c("#E69F00", "#56B4E9","#009E73","pink"),
