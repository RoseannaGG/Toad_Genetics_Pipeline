#look at relatedness
relthreshold <- 0.35
allout <- list.files("F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/Rmsibs/plink/")
outwd <- "F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/Rmsibs/plink/"
...
dim(sibrelover04_onlynomatchindiv)  #2100    3
  ...
  dim(sub_sibrelover04_onlynomatchindiv) #1436    3
  ...
  str(sub_sibrelover04_names.char) #chr [1:1436]
  ...
  str(sub_sibrelover04_names_unique.char) #chr [1:347]
  
  (347/766)*100
  
  
  write.table(sub_sibrelover04_names_unique.char, "F:/GBS_data_03_02_21/Lane_1_2_3_feb2023/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06_wss/766INDIV_3496SNPS/Rmsibs/listindiv_plink_sub_sib_rel_over_04_names_unique.char.txt", row.names = FALSE, col.names = FALSE,quote=FALSE )
