...
for sample in $files;
do
    bwa mem -M -t $cpu $bwa_db $src/Demultiplexing_stacks/lane1_lane2_lane3/${sample}.1.fq.gz $src/Demultiplexing_stacks/lane1_lane2_lane3/${sample}.2.fq.gz 2> $src/ANBO_refassembly_HGthesis_lane1_lane2_lane3/logs/bwa_lane2_B503.err|
