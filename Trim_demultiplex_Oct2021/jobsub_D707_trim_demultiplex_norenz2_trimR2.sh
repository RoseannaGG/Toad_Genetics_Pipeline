...
#SBATCH --mem=1000
#SBATCH --job-name=jobsub_D707_trim_demultiplex_norenz2_trimR2
#SBATCH --mail-user=roseanna.gamlen-greene@ubc.ca
#SBATCH --mail-type=ALL
#SBATCH --output=jobsub_D707_trim_demultiplex_norenz2_trimR2_%j.out
...
java -jar $EBROOTTRIMMOMATIC/trimmomatic-0.39.jar SE -threads 4 -trimlog /scratch/roseanna/Trimmed_reverseplates/D707_P7_R2_trimmed_log.txt /project/def-saitken/roseanna/rawreads_md5checked_feb272021/NS.1470.002.D707.Hamelin_202010_plate__3_R2.fastq.gz /scratch/roseanna/Trimmed_reverseplates/NS.1470.002.D707.Hamelin_202010_plate__3_R2.trimmed.fastq.gz HEADCROP:3


echo “Starting demultiplex,clean at: `date`”

#### NB timed out in the middle of demultiplexing so had to re run this part separately
