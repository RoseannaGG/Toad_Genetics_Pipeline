...
#SBATCH --mem=1000
#SBATCH --job-name=jobsub_D701_trim_demultiplex_norenz2_trimR2
#SBATCH --mail-user=roseanna.gamlen-greene@ubc.ca
#SBATCH --mail-type=ALL
#SBATCH --output=jobsub_D701_trim_demultiplex_norenz2_trimR2_%j.out
