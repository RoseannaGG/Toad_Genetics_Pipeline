...
# NB Bad apple 2021 Jose Cera paper suggests running populations separately (with dif pop maps for region in my case) and then indentify individuals missing a lot of data first, then re-running populations with how datatset WITHOUT those bad apples in the pop map
